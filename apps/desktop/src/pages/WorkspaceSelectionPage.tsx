...
export function WorkspaceSelectionPage({
  ...
  const rootClassName = withinShell ? "flex flex-col gap-6" : "app-frame min-h-screen p-6";
            ...
            <PanelCard>
              ...
              <PanelCardFooter className="flex flex-col gap-2 sm:flex-row">
                ...
                <QuietPageAction
                  className="sm:flex-1"
                  clientLog={{
                    action: "워크스페이스 새로고침 CTA 클릭",
                    description: "외부 변경 이후 워크스페이스 목록을 다시 확인했습니다.",
                    source: "workspace-selection",
                  }}
      ...
      <div className={listRootClassName}>
        <ElevatedPanel as="header" padding="lg">
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-[var(--muted-foreground)]">
            각 워크스페이스는 전용 GitHub 문서 저장소 하나와, 앱이 관리하는 승인 및 발행 이력을
            가집니다.
          </p>
        </ElevatedPanel>
